...
const flattenSubjectData = (s: Subject) => ({
    ...
    'D0 HRV RMSSD Baseline': s.day0.t0?.hrvRmssd,
    'D0 HRV SDNN Baseline': s.day0.t0?.hrvSdnn,
    'D0 SmO2 Baseline': s.day0.t0?.nirs,
    'D0 THb Baseline': s.day0.t0?.thb,
    'D0 Skin Temp Baseline': s.day0.t0?.skinTemperature,
    'D0 Thigh Circ Baseline': s.day0.t0?.thighCircumference,
    'D0 Quad Stiffness (cm)' : s.day0.quadricepsStiffnessInitial,
    ...
    'D0 Skin Temp Fatigue': s.day0.t1?.skinTemperature,
    'D0 Thigh Circ Fatigue': s.day0.t1?.thighCircumference,
    ...
    'D2 HRV RMSSD Pre': s.day2.t2?.hrvRmssd,
    'D2 HRV SDNN Pre': s.day2.t2?.hrvSdnn,
    'D2 SmO2 Pre': s.day2.t2?.nirs,
    'D2 THb Pre': s.day2.t2?.thb,
    'D2 Skin Temp Pre': s.day2.t2?.skinTemperature,
    'D2 Thigh Circ Pre': s.day2.t2?.thighCircumference,
    'D2 Quad Stiffness Pre (cm)': s.day2.quadricepsStiffnessPre,
    ...
    'D2 Skin Temp Post': s.day2.t3?.skinTemperature,
    'D2 Thigh Circ Post': s.day2.t3?.thighCircumference,
    'D2 SmO2 Gain': (s.day2.t3?.nirs || 0) - (s.day2.t2?.nirs || 0),
    'D2 THb Gain': (s.day2.t3?.thb || 0) - (s.day2.t2?.thb || 0),
    'D2 Quad Stiffness Post (cm)': s.day2.quadricepsStiffnessPost,
    'D2 Quad Gain (cm)': s.day2.quadricepsStiffnessPre - s.day2.quadricepsStiffnessPost,
    'D2 BIA Post R (T3)': s.day2.biaPost.r,
    'D2 BIA Post Xc (T3)': s.day2.biaPost.xc,
    'D2 BIA Post PhA (T3)': s.day2.biaPost.pha,
    'D2 HRV RMSSD Final': s.day2.t3?.hrvRmssd,
    'D2 HRV SDNN Final': s.day2.t3?.hrvSdnn,
    'D2 CMJ T3 (Recovery)': s.day2.t3?.cmj,

    // Follow-up
    'Follow-up Pain Resolved (Days)': s.followUp?.painResolvedDays ?? 'N/A',
    'Follow-up SmO2 72h': s.followUp?.t72h?.nirs,
    'Follow-up THb 72h': s.followUp?.t72h?.thb,
    'Follow-up Skin Temp 72h': s.followUp?.t72h?.skinTemperature,
    'Follow-up Thigh Circ 72h': s.followUp?.t72h?.thighCircumference,
    'Follow-up HRV RMSSD 72h': s.followUp?.t72h?.hrvRmssd,
    'Follow-up HRV SDNN 72h': s.followUp?.t72h?.hrvSdnn,
    'Follow-up CMJ 72h': s.followUp?.t72h?.cmj,
